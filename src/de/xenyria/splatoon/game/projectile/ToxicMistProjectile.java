...
public class ToxicMistProjectile extends SplatoonProjectile {

    public ToxicMistProjectile(SplatoonPlayer shooter, SplatoonWeapon weapon, Match match) {
    ...
    public ItemStack getBombItemStack() {
        ...
        return new ItemBuilder(Material.SPLASH_POTION).create();
    ...
    public void tick() {
        ...
        if(forceExplosion) {
            ...
            ToxicMist mist = new ToxicMist(getMatch(), getLocation(), getTeam());
            getMatch().addGameObject(mist);
