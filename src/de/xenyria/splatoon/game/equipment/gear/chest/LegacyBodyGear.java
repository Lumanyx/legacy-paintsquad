...
public class LegacyBodyGear extends BodyGear {

    public LegacyBodyGear(int originID, Brand brand, String itemName, SpecialEffect baseEffect, Material material, Color color, int maxSubAbilities, int cost) {
